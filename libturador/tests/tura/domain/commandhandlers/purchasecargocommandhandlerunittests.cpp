...
//   tura::domain::commands::PurchaseCargoCommand command;
//   tura::domain::commands::CommandBase<tura::domain::commands::PurchaseCargoCommand> wrappedCommand(command,
//   gameData);
...
//   tura::HarborBuilder harborBuilder;
//   auto harbor = harborBuilder.WithName("Test harbor").WithCargo(cargoName, harborCargoAmount,
//   harborCargoPrice).Build();
